...
function betaincinv(p, a, b, { upper = false } = {}) {
    ...
    const afac = -(0, special_gammaln_1.gammaln)(a) - (0, special_gammaln_1.gammaln)(b) + (0, special_gammaln_1.gammaln)(a + b);
    for (let j = 0; j < 10; j++) {
        if (x === 0 || x === 1) {
            return x;
        }
        const err = (0, special_betainc_1.betainc)(x, a, b) - p;
